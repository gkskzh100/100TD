...
class MonthView: UIView {
    ...
    @objc func btnLeftRightAction(sender: UIButton) {
        ...
        //currentMonthIndex 랑 currentYear 넘기는거
    ...
    func setupViews() {
        ...
        lblName.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -50).isActive=true
        ...
        btnLeft.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -110).isActive=true
